...
<body>
  ...
  <div class="container__child signup__form">
    <form action="addPatientGateway.cfm" class="registration_form" method="post" onsubmit="return check_Signup_Validation()">
	...
	<br>
	<br>
	<cfset DoctorList=application.dataManipulation.getDoctorNameID()>

	<div class="associateddoctors">
	<label for="associatedDoctor">Associated Doctor </label>
		<div class="form-group">

        			<select multiple name="associatedDoctor" id="associatedDoctor">
						<cfloop query="DoctorList">
							<cfoutput>

								<option  value="#DoctorList.doctorID#">#DoctorList.fullname#</option>
